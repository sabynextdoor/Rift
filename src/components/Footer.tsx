        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="md:col-span-1">
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <span className="headline-condensed text-base text-text-primary tracking-wider">RIFT</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {['Features', 'Security', 'Pricing', 'API'].map((item) => (
                <li key={item}>
                  <a href="#" className="text-sm text-text-muted hover:text-text-primary transition-colors duration-200">{item}</a>
                </li>
              ))}
            </ul>
          </div>
