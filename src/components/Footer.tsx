    ...
    <footer className="relative border-t border-border">
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="md:col-span-1">
            <div className="flex items-center gap-2.5 mb-4">
              <div className="w-7 h-7 rounded-lg bg-accent/10 border border-accent/20 flex items-center justify-center">
                <svg width="14" height="14" viewBox="0 0 16 16" fill="none" className="text-accent-bright">
              ...
              <span className="text-base font-semibold tracking-tight text-text-primary">RIFT</span>
            </div>
          ...
          <div>
            <h4 className="text-body-sm font-medium text-text-primary mb-4">Product</h4>
            <ul className="space-y-2.5">
              {['Features', 'Security', 'Pricing', 'API'].map((item) => (
                <li key={item}>
                  <a href="#" className="text-body-sm text-text-secondary hover:text-text-primary transition-colors duration-200">{item}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            <h4 className="text-body-sm font-medium text-text-primary mb-4">Resources</h4>
            <ul className="space-y-2.5">
          ...
          <div>
            <h4 className="text-body-sm font-medium text-text-primary mb-4">Legal</h4>
            <ul className="space-y-2.5">
